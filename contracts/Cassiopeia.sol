...
contract Cassiopeia {
    ...
    function shareSecret(uint256 unlockTime, PVSSLib.PVSSCiphertext memory c) public returns (uint256) {
        // TODO: verify SNARK
    ...
    function submitShare(uint256 secretID, uint256 index, G2Point memory decrypted) public {
        ...
        secrets[secretID].decryptedShares.push(PVSSLib.PVSSDecryptedShare(index, decrypted));
    }
